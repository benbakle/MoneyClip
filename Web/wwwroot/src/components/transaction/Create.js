...
export default class Create extends React.Component {
 ...
 //<input className="date" type="text" value={this.props.transaction.date} />
                            //<Calendar onChange={this.onChange} value={this.state.date} />
                            //<input className="description" type="text" value={this.props.transaction.description} />
                            //<input className="income" type="text" value={this.props.transaction.amount} />
