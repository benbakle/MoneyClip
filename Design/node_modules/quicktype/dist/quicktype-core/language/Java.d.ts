...
import { BooleanOption, StringOption, Option, OptionValues } from "../RendererOptions";
...
export declare function javaNameStyle(startWithUpper: boolean, upperUnderscore: boolean, original: string): string;
