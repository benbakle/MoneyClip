...
export declare const inferenceFlagNames: ("combineClasses" | "inferMaps" | "inferEnums" | "inferDateTimes" | "inferUuids" | "inferIntegerStrings" | "inferBooleanStrings" | "ignoreJsonRefs")[];
export declare const inferenceFlags: {
    [F in keyof typeof inferenceFlagsObject]: InferenceFlag;
};
export declare type InferenceFlags = {
    [F in keyof typeof inferenceFlagsObject]: boolean;
};
/**
